...
namespace hyperTROPHYbuddy.Services
{
    public interface IPlanService
    {
        ...
        Task<WorkoutPlan> CreatePlan(WorkoutPlan plan, List<int> workoutIds, string adminId);
        Task UpdatePlan(WorkoutPlan plan, List<int> workoutIds, string adminId);
        ...
        Task<IEnumerable<WorkoutPlan>> SearchPlans(string searchTerm, string adminId);
    }
}
