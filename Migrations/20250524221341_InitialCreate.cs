        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Workouts_AspNetUsers_CreatedByAdminId",
                        column: x => x.CreatedByAdminId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    WorkoutPlanAssignmentId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    WorkoutPlanId = table.Column<int>(type: "int", nullable: true),
                    AssignedToClientId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    AssignedByAdminId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    WorkoutPlanId1 = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_WorkoutPlanAssignments", x => x.WorkoutPlanAssignmentId);
                    table.ForeignKey(
                        name: "FK_WorkoutPlanAssignments_AspNetUsers_AssignedByAdminId",
                        column: x => x.AssignedByAdminId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_WorkoutPlanAssignments_AspNetUsers_AssignedToClientId",
                        column: x => x.AssignedToClientId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WorkoutPlanWorkout", x => new { x.WorkoutPlanId, x.WorkoutId });
                    table.ForeignKey(
                        name: "FK_WorkoutPlanWorkout_WorkoutPlans_WorkoutPlanId",
                        column: x => x.WorkoutPlanId,
                        principalTable: "WorkoutPlans",
                        principalColumn: "WorkoutPlanId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_WorkoutPlanWorkout_Workouts_WorkoutId",
                        column: x => x.WorkoutId,
                        principalTable: "Workouts",
                        principalColumn: "WorkoutId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WorkoutPlanAssignments_AssignedByAdminId",
                table: "WorkoutPlanAssignments",
                column: "AssignedByAdminId");

            migrationBuilder.CreateIndex(
                name: "IX_WorkoutPlanAssignments_AssignedToClientId",
                table: "WorkoutPlanAssignments",
                column: "AssignedToClientId");

            migrationBuilder.CreateIndex(
                name: "IX_WorkoutPlanAssignments_WorkoutPlanId",
                table: "WorkoutPlanAssignments",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Workouts_CreatedByAdminId",
                table: "Workouts",
                column: "CreatedByAdminId");
        }
